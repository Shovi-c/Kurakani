...
constexpr auto qt_meta_stringdata_CLASSLoginwindowENDCLASS = QtMocHelpers::stringData(
    ...
    "",
    "on_Sup_clicked",
    "on_Userline_cursorPositionChanged",
    "arg1",
    "arg2"
);
...
Q_CONSTINIT const QMetaObject Loginwindow::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSLoginwindowENDCLASS_t,
        ...
        // method 'on_LoginOk_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_Sup_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_Userline_cursorPositionChanged'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void Loginwindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->on_LoginOk_clicked(); break;
        case 1: _t->on_Sup_clicked(); break;
        case 2: _t->on_Userline_cursorPositionChanged((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        default: ;
        }
    }
}
